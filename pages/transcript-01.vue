    ...
    <main-section theme="sidebar-right">
      <template v-slot:default>
        <div class="content">
          ...
          <p>
            00:24 I started this podcast for intermediate learners. There’s a lot of content out there to help beginners, and a ton of English media created for native speakers. But what do you do if you’re in the middle? If you understand the basics, but many TV shows or podcasts are still too hard?
          </p>
          <p>
            00:40 I had this exact same problem when I was learning French. Luckily, I found a podcast called Inner French that was a perfect level for me. It was slower than others, but still talked about interesting topics so I didn’t get bored. And, I could read along with the transcript at first when there were some parts that I really didn’t understand. After listening for a few months, it was easier for me to understand French news and TV shows. And I felt a little more confident speaking French, since I knew what it should sound like. 
          </p>
          <p>
            01:11 I was inspired to create this same kind of podcast for my students. 
          </p>
          <p>
            01:15 Alright so today we’re going to talk about the psychology behind learning languages. How does our brain actually learn language?
          </p>
          <p>
            01:22 Oh and a quick reminder before we start- it’s totally normal not to understand everything the first time that you hear it. Listening to the same thing a few times, can help. Also reading the transcript while you listen can help train your brain to match sounds to words.
          </p>
          <p>
            01:37 Okay, back to today’s topic. Psychologists, people who study the brain and human behavior, and linguistic researchers, people who study language itself, have many theories about how humans learn languages. One guy in particular, Stephen Krashen, has a really interesting theory about this.
          </p>
          <p>
            01:55 Stephen Krashen is an American linguist and professor at the University of Southern California. In the 80’s, in the years around 1980, he published many books and articles that changed the way languages are taught in schools. These theories were very influential among researchers and teachers, including me! I’ve based this podcast and a lot of my teaching style on his theories. The main idea is to learn languages in a more natural way.
          </p>
          <p>
            02:21 So today we’re going to talk about his Theory of Second Language Acquisition. There are 5 hypotheses, 5 main points in this theory.
          </p>
          <p>
            02:30 #1: The Acquisition-Learning Hypothesis
          </p>
          <p>
            02:35 First of all, Professor Krashen says we must differentiate; we must make a difference between acquisition and learning.
          </p>
          <p>
            02:42 The word acquisition comes from the verb acquire. To acquire something means you get something. For example, if you buy an iPhone, you acquire it. Now the iPhone belongs to you. Then what does this mean to acquire a language? Acquiring a language is how you learn your native language. It’s what happens when you are a child, and without making a huge effort, you start to speak. You feel hungry, or you want to sleep, so you have to try to express yourself, to share those ideas. Parents reinforce this by their happy reactions or giving you what you want. Later on, they might correct your language, but mostly you learn through exposure. You listen to the world around you, and like magic you can speak. For Professor Krashen this is the natural way to learn a language. He thinks acquisition is the best way to learn, even for a foreign language.
          </p>
           <p>
          ...
          <p>
            04:00 Krashen thinks that when we learn a language like this in school, we’re not learning how to actually communicate in that language. I’ve experienced this myself with French. I studied it for 4 years in high school, but when I visited Paris for the first time it was still really hard to talk to people and understand them. So, to summarize the first hypothesis, Professor Krashen says that we should try to acquire languages, like the way children learn their native language, instead of learning them the traditional way.
          </p>
           <p>
            04:26 Clearly, there’s some criticism of this first hypothesis. In my opinion, when you learn another language as an adult, it is helpful to learn some basic grammar rules. The first step is to learn some simple words and structures. Like this you can communicate some basic ideas, and start trying to understand the language when you hear it. I think of it as a little boost, or a little head start. But as soon as you can I’d recommend going the natural route- listening to a ton of content and then trying to speak, even if you make mistakes. Making mistakes isn’t a big deal at all. It’s actually a super important part of how our brain retains information.
          </p>
          <p>
            05:03 #2: The Monitor Hypothesis
          </p>
           <p>
            05:06 First off, what’s a monitor? Well, it’s like a controller, someone who controls or checks. For example, someone who checks your ticket in the metro, or checks your passport when you go to another country. It’s a person who makes sure you are following the rules.
          </p>
          <p>
            05:21 When we learn a language, there’s a monitor in our brain. It tries to see if we are respecting all the rules. The grammar rules, the pronunciation rules. And something interesting about this Monitor, this little controller guy is that not everyone has the same kind. If you’re someone who’s more extroverted, which means a person who gets energy from being around people a lot of the time, the monitor is quieter. The controller in your brain has less influence on you. You can talk, and it doesn’t stop you. It’s not a big deal if you don’t follow all the rules. 
          </p>
           <p>
            05:51 On the other hand, if you’re more introverted. If you’re the kind of person that needs some more alone time, the monitor is very active. Us introverts often want to feel prepared for social situations. We want to know what to say. So as soon as you try to speak another language, the monitor starts making sure you’re following all the rules perfectly. It doesn’t want you to make a single mistake. That, unfortunately, is not so helpful. To improve you have to speak, even if you’re not sure if what you say is 100% correct. If you don’t try to express ideas, if you don’t make mistakes, you won’t make progress in the language.
          </p>
          <p>
            06:27 It’s normal to be afraid to make mistakes, but everyone makes them. Probably like 95% of the time the person you’re talking to isn’t judging your mistakes, they’re actually thinking it’s so cool that you’re making an effort to speak their language. 
          </p>
           <p>
            06:41 So, Krashen’s second hypothesis says that we have to tell our monitor to be quiet. We have to limit the influence of the controller so it doesn’t block us from speaking. It might never be completely silent, but we get better at telling it to chill for a bit and let us talk. 
          </p>
          <p>
            06:57 #3: The Input Hypothesis
          </p>
           <p>
            07:02 Alright so now we need to talk about Input. Input means something that comes in. It starts outside, and it comes inside. This is another super important point from our friend Professor Krashen. The Input Hypothesis says that when we learn a second language, we have to try to understand content. When you read an article, listen to a podcast, or when you watch a video in English you’re getting input. You hear or see some English, and you’ve gotta [got to] try to understand it. 
          </p>
          <p>
            07:29 But it can’t just be any content. If it’s too easy, you won’t learn anything new. To acquire a language, we have to try to understand things that are a little too difficult. We need to read articles or listen to audio that’s at a slightly higher level than our current level. Things that are a little hard to understand on the first try. This way, your brain has to make an effort. It has to use the context to understand.
          </p>
           <p>
